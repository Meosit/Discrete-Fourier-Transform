...
if __name__ == '__main__':
    ...
    spectrum = fourier_spectrum(original_poly_signal_values)
    repaired_poly_signal_values = [repaired_polyharmonic_signal(i, spectrum) for i in range(N)]
    polyharmonic_signals_values = [original_poly_signal_values, repaired_poly_signal_values]

    draw_signal_comparison(harmonic_signals_values, polyharmonic_signals_values, LABELS)
